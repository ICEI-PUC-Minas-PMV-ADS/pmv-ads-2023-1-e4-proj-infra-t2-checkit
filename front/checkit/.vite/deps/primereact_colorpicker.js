...
var ColorPickerPanel = React8.forwardRef(function(props, ref) {
  var createElement3 = function createElement4() {
    ...
    return React8.createElement(CSSTransition2, {
      nodeRef: ref,
  ...
  return props.inline ? element : React8.createElement(Portal, {
    element,
    appendTo: props.appendTo
  });
});
ColorPickerPanel.displayName = "ColorPickerPanel";
var ColorPicker = React8.memo(React8.forwardRef(function(inProps, ref) {
  var props = ColorPickerBase.getProps(inProps);
  var _React$useState = React8.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), overlayVisibleState = _React$useState2[0], setOverlayVisibleState = _React$useState2[1];
  var elementRef = React8.useRef(null);
  var overlayRef = React8.useRef(null);
  var inputRef = React8.useRef(props.inputRef);
  var colorSelectorRef = React8.useRef(null);
  var colorHandleRef = React8.useRef(null);
  var hueHandleRef = React8.useRef(null);
  var hueViewRef = React8.useRef(null);
  var hueDragging = React8.useRef(false);
  var hsbValue = React8.useRef(null);
  var colorDragging = React8.useRef(false);
  ...
  var createInput = function createInput2() {
    if (!props.inline) {
      ...
      return React8.createElement("input", _extends2({
        ref: inputRef,
        type: "text",
        readOnly: true,
  ...
  return React8.createElement(React8.Fragment, null, React8.createElement("div", _extends2({
    ref: elementRef,
    id: props.id,
    style: props.style,
    className
  }, otherProps), input, React8.createElement(ColorPickerPanel, {
    ref: overlayRef,
    appendTo: props.appendTo,
    inline: props.inline,
    disabled: props.disabled,
  ...
  }, content)), hasTooltip && React8.createElement(Tooltip, _extends2({
    target: elementRef,
